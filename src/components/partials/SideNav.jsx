  ...
  return (
     <div className='w-[20%] h-full border-r-2 border-zinc-400 p-3'>
      ...
      <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
        ...
        <Link className='hover:bg-[#6556CD] hover:text-white rounded-2xl p-3 duration-300'><i className="mr-2 ri-fire-fill"></i>Trending</Link>
        <Link className='hover:bg-[#6556CD] hover:text-white rounded-2xl p-3 duration-300'><i className=" mr-2 ri-bard-fill"></i>Popular</Link>
        <Link className='hover:bg-[#6556CD] hover:text-white rounded-2xl p-3 duration-300'><i className="mr-2 ri-movie-2-fill"></i>Movies</Link>
